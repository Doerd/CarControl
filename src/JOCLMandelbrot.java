...
public class JOCLMandelbrot
{
    ...
    /**
     * Creates a new JOCLMandelbrot  
     */
    public JOCLMandelbrot()
    {
        // Initialize OpenCL 
        initCL();
    ...
    private void initCL()
    {
        ...
        String source0 = readFile("kernels/QuadFloat.cl");
        String source1 = readFile("kernels/QuadFloatMandelbrot.cl");
