...
public class Arduino { // Adapted to Java from arduino.cs ... (FakeFirmata)
 // (subclass this to add input capability)
  ...
  protected int[] digitalOutputData; protected
  ...
  */
  public boolean IsOpen() {return GoodOpen;} // true if opened successfully
  ...
  */
  public static void HookExtend(SimHookBase whom) {DoMore = whom;}
  ...
  public void Open() {
    ...
    if (SpeakEasy) {
      if (GoodOpen) System.out.println("... " + CommPortNo + " is now open");
        else System.out.println("... " + CommPortNo + " failed to open");}} //~Open
