...
public class PrimitiveBlobFilter implements IMovingBlobReduction {
	...
	/**
	 * Checks the list of potential pedestrian blobs to distinguish pedestrians from
	 * non-pedestrians. Non-pedestrians are removed from the list of blobs.
	 *
	 * @param blobs
	 *            the list of potential pedestrian blobs
	 * @return the list of blobs determined to be pedestrians
	 */
	@Override
	// defines the 8 blob properties within the list
	//part 1 
